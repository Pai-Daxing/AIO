...
void MyKeyboard::setNumKeyModel(QStringList list)
{
    ...
    m_numKeyModel.append("删除");
    m_numKeyModel.append("0");
    m_numKeyModel.append("英文");
    m_numKeyModel.append("中文");
    m_numKeyModel.append("符号");
    m_numKeyModel.append("关闭");

}

void MyKeyboard::setSymbolKeyModel(QStringList list)
{
    list.append("no use");

    m_symbolKeyModel.append("空格");
    m_symbolKeyModel.append(".");
    m_symbolKeyModel.append("-");
    m_symbolKeyModel.append("+");
    m_symbolKeyModel.append("=");
    m_symbolKeyModel.append("_");
    m_symbolKeyModel.append("*");
    m_symbolKeyModel.append("@");
    m_symbolKeyModel.append("#");
    m_symbolKeyModel.append("&");
    m_symbolKeyModel.append("删除");
    m_symbolKeyModel.append("英文");
    m_symbolKeyModel.append("中文");
    m_symbolKeyModel.append("123");
    m_symbolKeyModel.append("关闭");
...
void MyKeyboard::setEnglishKeyModel(QStringList list)
{
    ...
    m_englishKeyModel.append("中文");
    m_englishKeyModel.append("符号");
    m_englishKeyModel.append("删除");
...
void MyKeyboard::englishCaseSwitch(QString type)
{
    ...
    m_englishKeyHash.insert("中文", NULL);
...
void MyKeyboard::setChineseKeyModel(QStringList list)
{
    ...
    m_chineseKeyModel.append(tmpStr);
    m_chineseKeyModel.append("符号");
    m_chineseKeyModel.append("英文");
    m_chineseKeyModel.append("删除");
...
{
    if(caseMode == "小写" && m_curInputLanguage=="英文")
    {
       caseMode = "大写";
    }
    else //if(caseMode == "大写")
    ...
    if(m_curInputLanguage=="中文" || (m_curInputLanguage=="英文" && caseMode=="小写"))
        index = 'a';
    else
        index = 'A';
...
QString MyKeyboard::simulateKeyPressEvent(QString key, QString str)
{
    ...
    if(key == "大写" || key == "小写")
    {
        if(key=="小写" && m_curInputLanguage=="中文")
            m_curInputLanguage = "英文";
...
void MyKeyboard::symbolKeyPress(QString key)
{
    if(key == "返回")
    {
        m_fullKeyboardFlag = m_lastfullFlag;
...
QStringList MyKeyboard::getKeyModel()
{
    ...
    else if(m_curInputLanguage == "中文")
        return m_chineseKeyModel;
    else if(m_curInputLanguage == "符号")
        return m_symbolKeyModel;
}
