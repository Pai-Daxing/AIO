...
public:
    ...
    Q_PROPERTY(QStringList symbolModel READ getSymbolKeyModel WRITE setSymbolKeyModel NOTIFY symbolKeyModelChanged)
    ...
    Q_INVOKABLE bool isSymbolInput();
    ...
    inline QStringList getSymbolKeyModel()
    {
    ...
    void setSymbolKeyModel(QStringList list);
...
private:
    ...
    void symbolKeyPress(QString key);
